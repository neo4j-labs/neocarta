...
class SnowflakeSchemaTransformer:
    """
    ...
    def __init__(self) -> None:
        """Initialize the Snowflake transformer."""
    ...
    def transform_to_database_nodes(
        ...
        """
        Transform Snowflake database information into database nodes.

        Parameters
        ----------
        database_info: pd.DataFrame
            A Pandas DataFrame containing the database information. Has column `database`.
        cache: bool = True
        ...
        database_nodes = [
            Database(
                id=generate_database_id(row.database),
                name=row.database,
                description=None,
                platform="SNOWFLAKE",
                service="SNOWFLAKE",
    ...
    def transform_to_schema_nodes(
        ...
        """
        Transform Snowflake schema information into schema nodes.
    ...
    def transform_to_table_nodes(self, table_info: pd.DataFrame, cache: bool = True) -> list[Table]:
        """
        Transform Snowflake table information into table nodes.
    ...
    def transform_to_column_nodes(
        ...
        """
        Transform Snowflake column information into column nodes.
    ...
    def transform_to_value_nodes(self, value_info: pd.DataFrame, cache: bool = True) -> list[Value]:
        """
        Transform Snowflake value information into value nodes.
    ...
    def transform_to_has_schema_relationships(
        ...
        """
        Transform Snowflake schema information into has schema relationships.
    ...
    def transform_to_has_table_relationships(
        ...
        """
        Transform Snowflake table information into has table relationships.
    ...
    def transform_to_has_column_relationships(
        ...
        """
        Transform Snowflake column information into has column relationships.
    ...
    def transform_to_references_relationships(
        ...
        """
        Transform Snowflake column references information into references relationships.
        ...
        # (SHOW IMPORTED KEYS returns only foreign keys), so every row here is a foreign
        # key — iterate directly rather than re-filtering, which also tolerates an empty
        # frame that carries no ``constraint_type`` column.
    ...
    def transform_to_has_value_relationships(
        ...
        """
        Transform Snowflake value information into has value relationships.
