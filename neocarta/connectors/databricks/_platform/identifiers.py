"""Databricks identifier and path helpers for the connector."""
...
# Catalogs the connector must never create or drop. The build and
...
def validate_uc_volume_subpath(value: str, *, label: str = "UC Volume path") -> str:
    ...
    Databricks writes run artifacts, staging data, and ledgers below a UC Volume,
