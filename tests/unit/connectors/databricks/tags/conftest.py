"""Fixtures for the Databricks governance-tags connector unit tests.
...
from neocarta.connectors.databricks.tags.transform import DatabricksTagsTransformer

# Raw metastore id the mocked workspace reports; the id namespace derives from it.
...
def extractor(mock_workspace_client):
    """A DatabricksTagsExtractor with the mocked workspace client."""
    return DatabricksTagsExtractor(mock_workspace_client)
...
@pytest.fixture
def transformer():
    return DatabricksTagsTransformer()
