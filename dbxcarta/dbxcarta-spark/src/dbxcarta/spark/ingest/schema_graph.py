...
def build_database_nodes(
    ...
    catalog dbxcarta ingests is a Unity Catalog catalog. `platform` is the
    ...
    rows = [
        (generate_id(c), c, platform, DATABASE_SERVICE, None, CONTRACT_VERSION, c) for c in catalogs
    ]
